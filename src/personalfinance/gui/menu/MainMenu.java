...
public class MainMenu extends JMenuBar implements Refresh, EnableEditDelete {
	...
	private void init() {
		...
		addMenuItem(file, Text.get("MENU_FILE_OPEN"), Style.ICON_MENU_FILE_OPEN, HandlerCode.MENU_FILE_NEW, KeyEvent.VK_O);
		addMenuItem(file, Text.get("MENU_FILE_SAVE"), Style.ICON_MENU_FILE_SAVE, HandlerCode.MENU_FILE_NEW, KeyEvent.VK_S);
		addMenuItem(file, Text.get("MENU_FILE_UPDATE_CURRENCIES"), Style.ICON_MENU_FILE_UPDATE_CURRENCIES, HandlerCode.MENU_FILE_NEW);
		addMenuItem(file, Text.get("MENU_FILE_EXIT"), Style.ICON_MENU_FILE_EXIT, HandlerCode.MENU_FILE_NEW);
		...
		addMenuItem(help, Text.get("MENU_HELP_ABOUT"), Style.ICON_ABOUT, HandlerCode.MENU_HELP_ABOUT);
	}
